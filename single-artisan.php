...
$portrait = get_field('portrait_mini');
if(empty($portrait)){
    $portrait = get_field('thumbnail');;
}
                        ...
                        <?php 
                            if(!empty($email)){?>
                                <a target="_blank" href="mailto:<?php echo $email ?>">
                                    <svg width="39" height="31" viewBox="0 0 41 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <?php 
                            if(!empty($website)){?>
                                <a target="_blank" href="<?php echo $website ?>">
                                    <svg width="39" height="39" viewBox="0 0 41 41" fill="none" xmlns="http://www.w3.org/2000/svg">
